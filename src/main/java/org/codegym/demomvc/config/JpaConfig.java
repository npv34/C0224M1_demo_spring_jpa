...
@EnableJpaRepositories(basePackages = "org.codegym.demomvc.repository")  // Kích hoạt Spring Data JPA và chỉ định package chứa các repository
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("org.codegym.demomvc.model");  // Các package chứa các entity classes
